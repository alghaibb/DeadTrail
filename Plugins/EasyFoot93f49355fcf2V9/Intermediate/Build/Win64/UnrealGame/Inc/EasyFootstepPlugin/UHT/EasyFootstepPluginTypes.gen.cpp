...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFootstepTypeData_Statics::NewProp_SurfaceSoundData_ValueProp = { "SurfaceSoundData", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FFootstepSoundData, METADATA_PARAMS(0, nullptr) }; // 3584930406
...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FFootstepTypeData_Statics::NewProp_SurfaceEffectData = { "SurfaceEffectData", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FFootstepTypeData, SurfaceEffectData), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SurfaceEffectData_MetaData), NewProp_SurfaceEffectData_MetaData) }; // 4016136629
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFootstepTypeData_Statics::NewProp_SurfaceDecalData_ValueProp = { "SurfaceDecalData", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FFootstepDecalData, METADATA_PARAMS(0, nullptr) }; // 2930357908
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFootstepTypeData_Statics::NewProp_SplashSoundData_ValueProp = { "SplashSoundData", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FFootstepSoundData, METADATA_PARAMS(0, nullptr) }; // 3584930406
...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FFootstepTypeData_Statics::NewProp_SplashEffectData = { "SplashEffectData", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FFootstepTypeData, SplashEffectData), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SplashEffectData_MetaData), NewProp_SplashEffectData_MetaData) }; // 4016136629
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFootstepTypeData_Statics::NewProp_SplashDecalData_ValueProp = { "SplashDecalData", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FFootstepDecalData, METADATA_PARAMS(0, nullptr) }; // 2930357908
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyFootstepPlugin_Source_EasyFootstepPlugin_Public_EasyFootstepPluginTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EFootstepType_StaticEnum, TEXT("EFootstepType"), &Z_Registration_Info_UEnum_EFootstepType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1558751829U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FFootstepSoundData::StaticStruct, Z_Construct_UScriptStruct_FFootstepSoundData_Statics::NewStructOps, TEXT("FootstepSoundData"), &Z_Registration_Info_UScriptStruct_FootstepSoundData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFootstepSoundData), 3584930406U) },
		{ FFootstepEffectData::StaticStruct, Z_Construct_UScriptStruct_FFootstepEffectData_Statics::NewStructOps, TEXT("FootstepEffectData"), &Z_Registration_Info_UScriptStruct_FootstepEffectData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFootstepEffectData), 4016136629U) },
		{ FFootstepDecalData::StaticStruct, Z_Construct_UScriptStruct_FFootstepDecalData_Statics::NewStructOps, TEXT("FootstepDecalData"), &Z_Registration_Info_UScriptStruct_FootstepDecalData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFootstepDecalData), 2930357908U) },
		{ FFootstepTypeData::StaticStruct, Z_Construct_UScriptStruct_FFootstepTypeData_Statics::NewStructOps, TEXT("FootstepTypeData"), &Z_Registration_Info_UScriptStruct_FootstepTypeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFootstepTypeData), 2492901907U) },
		{ FFootstepSettings::StaticStruct, Z_Construct_UScriptStruct_FFootstepSettings_Statics::NewStructOps, TEXT("FootstepSettings"), &Z_Registration_Info_UScriptStruct_FootstepSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFootstepSettings), 3786506003U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyFootstepPlugin_Source_EasyFootstepPlugin_Public_EasyFootstepPluginTypes_h_1866608170(TEXT("/Script/EasyFootstepPlugin"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyFootstepPlugin_Source_EasyFootstepPlugin_Public_EasyFootstepPluginTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyFootstepPlugin_Source_EasyFootstepPlugin_Public_EasyFootstepPluginTypes_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyFootstepPlugin_Source_EasyFootstepPlugin_Public_EasyFootstepPluginTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyFootstepPlugin_Source_EasyFootstepPlugin_Public_EasyFootstepPluginTypes_h_Statics::EnumInfo));
// End Registration
